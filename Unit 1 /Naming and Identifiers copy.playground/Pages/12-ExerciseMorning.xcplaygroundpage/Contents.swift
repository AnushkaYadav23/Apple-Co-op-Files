...
let MoringRoutine = brushTeeth + shower + getDressed + eatBreakfast + packBag + wearShoes
/*:
 ...
 */
let tasksILike = getDressed + eatBreakfast + wearShoes
let tasksIMustComplete = brushTeeth + shower
/*:
