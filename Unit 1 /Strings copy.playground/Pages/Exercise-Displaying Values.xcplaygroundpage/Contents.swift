 ...
 */
let totalStorange = 8000
let currentStorage = 3000
let videoStorage = 150
let totalMinOfMoreVideos = (totalStorange - currentStorage) / videoStorage
let display = "You can record \(totalMinOfMoreVideos) more minutes of video."
