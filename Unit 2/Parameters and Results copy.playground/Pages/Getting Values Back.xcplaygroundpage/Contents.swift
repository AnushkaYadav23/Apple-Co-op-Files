...
func math(num1: Int, num2: Int) -> String {
    let number1 = 1000
    let number2 = 100
    let mathEquation = number1 + number2
    
    return "The sum of \(number1) and \(number2) is \(mathEquation)"
}

let answer = math(num1: 1000, num2: 100)
print(answer)
