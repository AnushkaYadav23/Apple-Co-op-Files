...
func sentence(categoryOfThing: String, favorite: String) -> String {
    let fullSentence = "My favorite \(categoryOfThing) is \(favorite)"
    return fullSentence

}
let favThing = sentence(categoryOfThing: "food", favorite: "Cheese.")
print(favThing)

let favThing2 = sentence(categoryOfThing: "car", favorite: "Toyota.")
print(favThing2)

let favThing3 = sentence(categoryOfThing: "colour", favorite: "Blue.")
print(favThing3)
 ...
 */
let everything = "Hello! My name is Anushka! \(favThing) \(favThing2) \(favThing3)"
print(everything)
/*:
