...
let fullSentence = impossibleThingsPhrase(numberOfImpossibleThings: number, meal: food)
print(fullSentence)

let count = impossibleBeliefsCount(pigsFlying: 100, frogsBecomingPrinces: 88, multipleLightningStrikes: 99)
let phrase = impossibleThingsPhrase(numberOfImpossibleThings: count, meal: "Cake")
/*:
