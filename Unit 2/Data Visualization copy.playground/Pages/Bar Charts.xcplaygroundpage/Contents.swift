...
addBar(withLength: 3, color: .green)
addBar(withLength: 1, color: .red)
addBar(withLength: 9, color: .purple)
addBar(withLength: 4, color: .blue)
addBar(withLength: 6, color: .magenta)
