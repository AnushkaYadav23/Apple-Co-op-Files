...
addPointAt(x: 0, y: 0, color: .magenta)
addPointAt(x: 1, y: 1, color: .magenta)
addPointAt(x: 2, y: 2, color: .magenta)
addPointAt(x: 3, y: 3, color: .magenta)
addPointAt(x: 4, y: 4, color: .magenta)
addPointAt(x: 5, y: 5, color: .magenta)
addPointAt(x: 6, y: 6, color: .magenta)
addPointAt(x: 7, y: 7, color: .magenta)
addPointAt(x: 8, y: 8, color: .magenta)
addPointAt(x: 9, y: 9, color: .magenta)
addPointAt(x: 10, y: 10, color: .magenta)
